...
router.patch('/result', async (req, res) => {
  try {
    ...
    let calcPointsA = (preresultInt[0] - preresultInt[1]);

    let maior, menor;

    if(calcPointsA > 0){

      if((findReport.teamsobj[0].points + findReport.teamsobj[1].points + findReport.teamsobj[2].points) > (findReport.teamsobj[3].points + findReport.teamsobj[4].points + findReport.teamsobj[5].points)){
        maior = (findReport.teamsobj[0].points + findReport.teamsobj[1].points + findReport.teamsobj[2].points);
        menor = (findReport.teamsobj[3].points + findReport.teamsobj[4].points + findReport.teamsobj[5].points);
        if(maior === 0){
          maior = 1;
        }
        if(menor === 0){
        ...
        console.log("1-->"+calcPointsA);
        if((menor/maior) < 0.5){
          calcPointsA = Math.round(10*calcPointsA*0.5);
        }else{
        calcPointsA = Math.round(10*calcPointsA*(menor/maior));
        }
        calcPointsA = Math.trunc( calcPointsA );
        console.log("2-->"+calcPointsA);
      }else{
        menor = (findReport.teamsobj[0].points + findReport.teamsobj[1].points + findReport.teamsobj[2].points);
        maior = (findReport.teamsobj[3].points + findReport.teamsobj[4].points + findReport.teamsobj[5].points);
        if(maior === 0){
          maior = 1;
        }
        if(menor === 0){
        ...
        console.log("1-->"+calcPointsA);
        if((maior/menor) > 2){
          calcPointsA= Math.round(10*calcPointsA*2);
        }else{
          calcPointsA= Math.round(10*calcPointsA*(maior/menor));
        }
        calcPointsA = Math.trunc( calcPointsA );
        console.log("2-->"+calcPointsA);
      }
      console.log(calcPointsA);
    ...
    let calcPointsB = preresultInt[1] - preresultInt[0];
    ...
    if(calcPointsB > 0){
      ...
      if((findReport.teamsobj[0].points + findReport.teamsobj[1].points + findReport.teamsobj[2].points) > (findReport.teamsobj[3].points + findReport.teamsobj[4].points + findReport.teamsobj[5].points)){
        ...
        calcPointsB = Math.trunc( calcPointsB );
      }else{
        menor = (findReport.teamsobj[0].points + findReport.teamsobj[1].points + findReport.teamsobj[2].points);
        maior = (findReport.teamsobj[3].points + findReport.teamsobj[4].points + findReport.teamsobj[5].points);
        if(maior === 0){
